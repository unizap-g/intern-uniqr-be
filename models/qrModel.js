...
const qrCodeSchema = new mongoose.Schema({
  ...
  qrType: {
    ...
    enum: [
      // Static QR Types
      'URL', 'vCard', 'Call', 'WhatsApp', 'WIFI', 'Text', 'Email', 'SMS',
      // Dynamic QR Types
      'vCard Plus', 'Dynamic URL', 'PDF', 'Landing page', 'Images', 'Video', 
      'Social Media', 'App Download', 'Event', 'Restaurant Menu', 
      'Business Profile', 'List of Links', 'Product Catalogue', 
      'Lead Form', 'Google Review', 'Resume QR Code'
    ]
  },
  ...
  qrState: {
    ...
    enum: ['static', 'dynamic'],
    default: function() {
      const staticTypes = ['URL', 'vCard', 'Call', 'WhatsApp', 'WIFI', 'Text', 'Email', 'SMS'];
...
qrCodeSchema.virtual('scanRate').get(function() {
  ...
  return daysSinceCreation > 0 ? (this.analytics.totalScans / daysSinceCreation).toFixed(2) : 0;
});
...
qrCodeSchema.statics.getQRTypesByCategory = function() {
  return {
    static: ['URL', 'vCard', 'Call', 'WhatsApp', 'WIFI', 'Text', 'Email', 'SMS'],
    dynamic: [
      'vCard Plus', 'Dynamic URL', 'PDF', 'Landing page', 'Images', 'Video',
      'Social Media', 'App Download', 'Event', 'Restaurant Menu',
      'Business Profile', 'List of Links', 'Product Catalogue',
